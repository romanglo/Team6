 ...
 * 
 */
public class ServiceSpecialistController implements Initializable, Client.ClientStatusHandler, Client.MessageReceiveHandler
{
	...
	{
		if(textarea_analysis.getText().equals(""))
		{
			showInformationMessage("Specialist analisys area is empty");
		}
		else
		{
