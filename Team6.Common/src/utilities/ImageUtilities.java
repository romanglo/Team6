...
public class ImageUtilities
{
			...
			throws NullPointerException
	{
		...
		try {
			...
			returnedInputStream = new ByteArrayInputStream(imageInByte);
		}
		catch (Exception e) {
	 ...
	 * @param logger
	 *            An optional logger, will be used if the parsing process failed.
	 * @return A {@link Image} if the parsing succeed, <code>null</code> if
	 *         the parsing process failed.
	 * @throws NullPointerException
	 *             if one of the received parameter is null.
	 */
	public static Image InputStreamToImage(InputStream inputStream, @Nullable Logger logger)
			throws NullPointerException
	{
